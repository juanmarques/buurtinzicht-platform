        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-neutral-600 mt-1">{t('welcome', { name: user.name })}</p>
            </div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
              <div className="bg-white p-6 rounded-lg shadow-sm border border-neutral-200">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-medium text-neutral-600">{t('stats.searches')}</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-neutral-200">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-medium text-neutral-600">{t('stats.favorites')}</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-neutral-200">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-medium text-neutral-600">{t('stats.scorecards')}</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-neutral-200">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="text-sm font-medium text-neutral-600">{t('stats.thisYear')}</p>
                    <p className="text-2xl font-semibold text-neutral-900">+{stats.totalSearches}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6">
                {recentSearches.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-neutral-600">{t('recentSearches.empty')}</p>
                    <Link href="/search">
                      <Button variant="primary" className="mt-4">
                        {t('recentSearches.cta')}
                      </Button>
                    </Link>
                  </div>
                ) : (
                      ...
                      <div key={search.id} className="flex items-center justify-between p-3 bg-neutral-50 rounded-lg">
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-neutral-600">{t('recentSearches.results', { count: search.results })} • {search.date}</p>
                          </div>
                        </div>
                        <Button variant="ghost" size="sm">
                          {t('recentSearches.repeat')}
                        </Button>
                      </div>
                    ))}
                  </div>
              ...
              <div className="p-6">
                {favorites.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-neutral-600">{t('favorites.empty')}</p>
                    <Link href="/search">
                      <Button variant="primary" className="mt-4">
                        {t('favorites.cta')}
                      </Button>
                      ...
                      <div key={favorite.nisCode} className="flex items-center justify-between p-3 bg-neutral-50 rounded-lg">
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-neutral-600">{favorite.municipality} • {t('favorites.saved', { date: favorite.savedDate })}</p>
                          </div>
                        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-neutral-200 p-6">
              <div className="flex items-center mb-4">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-sm text-neutral-600">{t('profile.membership', { plan: user.plan })}</p>
                </div>
              </div>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-neutral-600">{t('profile.memberSince')}:</span>
                  <span className="text-neutral-900">{new Date(user.memberSince).toLocaleDateString('nl-BE')}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-neutral-600">{t('profile.lastActive')}:</span>
            ...
            {/* Quick Actions *}
            <div className="bg-white rounded-lg shadow-sm border border-neutral-200 p-6">
              <h3 className="font-semibold text-neutral-900 mb-4">{t('quickActions.title')}</h3>
