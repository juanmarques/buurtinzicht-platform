  ...
  const features = [
    {
      icon: MapPin,
      title: 'Buurt Zoeken',
      description: 'Vind je ideale buurt met geavanceerde zoekfilters en gedetailleerde informatie over voorzieningen.',
    },
    {
      icon: BarChart3,
      title: 'Gedetailleerde Scorecards',
      description: 'Krijg uitgebreide analyses van buurten met scores voor veiligheid, transport, voorzieningen en meer.',
    },
    {
      icon: Shield,
      title: 'Veiligheidsgegevens',
      description: 'Actuele criminaliteitsstatistieken en veiligheidsindicatoren voor elke buurt in België.',
    },
    {
      icon: Clock,
      title: 'Real-time Gegevens',
      description: 'Altijd actuele informatie dankzij integratie met overheidsdata en openbare bronnen.',
    },
    {
      icon: Users,
      title: 'Vergelijken',
      description: 'Vergelijk meerdere buurten naast elkaar om de beste keuze te maken.',
    },
  ];
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl text-neutral-700 mb-10 max-w-3xl mx-auto leading-relaxed">
              Maak slimme woonkeuzes met gedetailleerde buurtanalyses. Van veiligheid tot voorzieningen - 
              alle informatie die je nodig hebt op één plek.
            </p>
            ...
            <div className="mb-12 max-w-2xl mx-auto">
              <div className="relative">
                <input
                  type="text"
                  placeholder="Voer een adres, postcode of plaatsnaam in..."
              ...
              <p className="text-sm text-neutral-500 mt-3">
                Probeer bijvoorbeeld: <span className="font-medium">"Gent"</span>, <span className="font-medium">"1000 Brussel"</span>, of <span className="font-medium">"Mechelsestraat 10"</span>
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-3xl mx-auto">
              <Link href="/search?type=family" className="group">
                <div className="p-8 border-2 border-neutral-200 rounded-2xl hover:border-blue-300 hover:bg-blue-50 transition-all cursor-pointer h-full">
                  ...
                  <p className="text-neutral-600 mb-4">
                    Vind de perfecte buurt voor uw familie met scholen, speeltuinen en veiligheid.
                  </p>
                  <div className="flex items-center justify-center text-blue-600 group-hover:text-blue-700 font-medium">
                    Start zoeken <ArrowRight className="h-4 w-4 ml-2 group-hover:translate-x-1 transition-transform" />
                  </div>
                </div>
              </Link>
              ...
              <Link href="/search?type=business" className="group">
                <div className="p-8 border-2 border-neutral-200 rounded-2xl hover:border-green-300 hover:bg-green-50 transition-all cursor-pointer h-full">
                  ...
                  <p className="text-neutral-600 mb-4">
                    Ontdek zakelijke kansen met demografische data en marktanalyses.
                  </p>
                  <div className="flex items-center justify-center text-green-600 group-hover:text-green-700 font-medium">
                    Bekijk mogelijkheden <ArrowRight className="h-4 w-4 ml-2 group-hover:translate-x-1 transition-transform" />
                  </div>
                </div>
              </Link>
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-neutral-900 mb-6">
              Waarom kiezen voor Buurtinzicht?
            </h2>
            <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
              Onze platform combineert officiële data met slimme analyses om je 
              de meest accurate en actuele buurtinformatie te geven.
            </p>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-neutral-900 mb-6">
            Klaar om je ideale buurt te vinden?
          </h2>
          <p className="text-lg text-neutral-600 mb-10 max-w-2xl mx-auto">
            Begin vandaag nog met het ontdekken van buurten in België. 
            Gratis scorecards beschikbaar voor nieuwe gebruikers.
          </p>
